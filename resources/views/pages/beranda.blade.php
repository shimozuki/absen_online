        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <section class="col-md-12 mb-5">
                    <div class="card bg-white">
                        <div class="card-header bg-warning"> Absensi Terlambat dan izin </div>
                        <div class="card-body table-responsive p-0">
                                ...
                                <tbody>
                                    ...
                                    @if ($m->status === 2)
                                        ...
                                        @else
                                            ...
                                            <td class="table-secondary">{{ date_format($m->created_at, 'H:i:s') }} WIB</td>
                                                <td class="table-secondary">Izin/Sakit</td>
                                            </tr>
                                        @endif
                                    @endforeach
                                </tbody>
                    ...
                    <div class="card bg-white">
                        ...
                        <div class="card-body table-responsive p-0">
                        <div class="mb-3" style="display: flex; justify-content: flex-end; margin-top: 20px; margin-right: 20;">
    <label for="searchInput" class="form-label">Search:</label>
    <input type="text" class="form-control" id="searchInput" style="width: 200px;">
</div>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($muridAlpa as $m)
                                            <tr>
                                                ...
                                                <td class="table-danger">{{ $m->nis }}</td>
                                                <td class="table-danger"><a
                                                        href="/detail-murid/{{ $m->murid_id }}">{{ $m->nama }}</a>
                                                </td>
                                                <td class="table-danger"><a
                                                        href="#">{{ $m->nama_kelas }}</a>
                                                </td>
                                                <td class="table-danger">Tidak Masuk</td>
                                                <td class="table-danger"><form action="{{ route('izinsakit') }}" method="post">
    @csrf
    <input type="hidden" name="nis" value="{{ $m->nis }}">
    <button type="submit" class="btn btn-warning">Izin Atau Sakit</button>
</form></td>
                                            </tr>
                                    @endforeach
                                </tbody>
